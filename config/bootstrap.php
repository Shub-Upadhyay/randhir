...
// Create an instance of the RequestPolicy
$requestPolicy = new RequestPolicy();

// Configure the authorization service with the RequestPolicy
$authorizationService = new AuthorizationService(new OrmResolver(), $requestPolicy);

$middlewareQueue = new MiddlewareQueue();
// Register the AuthorizationMiddleware with the authorization service
$middlewareQueue->add(new AuthorizationMiddleware($authorizationService));
