...
$routes->prefix('client', function (RouteBuilder $builder) {
	...
	$builder->connect('/userpermission', [
		'controller' => 'UserPermission',
		'action' => 'index'
	]);

	$builder->connect('/requests', [
		'controller' => 'Request',
		'action' => 'index'
	]);

	$builder->connect('/documents', [
	...
	$builder->connect('/documentspermisson', [
		'controller' => 'DocumentPermission',
		'action' => 'index'
	]);
